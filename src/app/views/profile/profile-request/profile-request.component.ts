...
export class ProfileRequestComponent implements OnInit {
  ...
  newRequest(event: Event, eventIndex: number) {
    let tempBooking = new Booking(undefined, 'host-request', event.hostUser, this.artist, event, false, false, false, StatusMessages.waitingOnArtist, StatusMessages.hostOffer, false, false, true, event.fixedPrice, false, false);
